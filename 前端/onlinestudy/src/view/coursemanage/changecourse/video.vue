...
<script>
    ...
    export default {
        ...
        methods:{
            modifiy_save(){
                this.coursedata.ccontent = this.chapterData;
        ...
        mounted() {
            if(typeof this.coursedata.ccontent == "string"){
                this.chapterData = JSON.parse(this.coursedata.ccontent);
            }else {
                this.chapterData = this.coursedata.ccontent;
            }
